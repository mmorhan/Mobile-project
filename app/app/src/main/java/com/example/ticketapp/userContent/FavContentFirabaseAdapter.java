package com.example.ticketapp.userContent;
...
public class FavContentFirabaseAdapter extends FirebaseRecyclerAdapter<Content, FavContentFirabaseAdapter.myViewHolder> {
     ...
     * @param options
     */
    public FavContentFirabaseAdapter(@NonNull FirebaseRecyclerOptions options) {
        super(options);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.fav_content_list, parent, false);
    ...
    public class myViewHolder extends RecyclerView.ViewHolder {
        ...
        public myViewHolder(@NonNull View itemView) {
            super(itemView);
            content_header_image = itemView.findViewById(R.id.fav_content_header_image);
            content_header = itemView.findViewById(R.id.fav_content_header);
            content_description = itemView.findViewById(R.id.fav_content_description);
            content_date = itemView.findViewById(R.id.fav_content_date);
            content_source = itemView.findViewById(R.id.fav_content_source);
            content_favorite = itemView.findViewById(R.id.fav_content_favorites);
            content_readmore = itemView.findViewById(R.id.fav_content_readmore);
            content_id =itemView.findViewById(R.id.fav_content_id);
            image_path=itemView.findViewById(R.id.fav_image_path);

            addFav = (Button) itemView.findViewById(R.id.fav_content_favorites);
//
                ...
                public void onClick(View v) {
                    ...
                    childref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot snapshot) {
                            if (snapshot.exists()) {
                                Toast.makeText(v.getContext(),"Deleted from Favorites",Toast.LENGTH_SHORT).show();
                                snapshot.getRef().removeValue();

                            }
                            else {
                                Toast.makeText(v.getContext(),"Can't Delete from Favorites",Toast.LENGTH_SHORT).show();
                            }
                        }
                        @Override
        ...
        readMore=(Button)itemView.findViewById(R.id.fav_content_readmore);
