...
public class MainActivity5 extends AppCompatActivity {
    ...
    public void drawer_settings(View view) {
        Intent intent= new Intent(MainActivity5.this, SettingsActivity.class);
        startActivity(intent);

    }
    public  void goToMyFlight (View view){
        Intent intent= new Intent(MainActivity5.this, UserFlightActivity.class);
        startActivity(intent);
    }
    public  void goToCustomer(View view){
        Intent intent= new Intent(MainActivity5.this, MessageActivity.class);
        startActivity(intent);
    }
}